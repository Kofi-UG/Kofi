...
import com.example.pharmacymanagementsystem.Mapper.Purchase;
...
import com.example.pharmacymanagementsystem.Repository.PurchaseRepository;
import com.example.pharmacymanagementsystem.Repository.StockRepository;
...
public class DrugController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        Image image = new Image(getClass().getResourceAsStream("/refresh2.png"));
